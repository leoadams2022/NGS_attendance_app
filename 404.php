...
<body>
    ...
    <!--           <input type="text" placeholder="Search" /> -->
          ...
          <div id="navigation">
            <a class="navigation" href="<?php echo (isset($_SESSION['rank'])) ? ($_SESSION['rank']=== 'admin') ? ROOT.'admin/Dashboard.admin.php' : ROOT.'Dashboard.php' :  ROOT.'Dashboard.php'; ?>">Home</a>
            <!-- <a class="navigation" href="<?=ROOT?>sgin_in.php">Sgin In</a> -->
