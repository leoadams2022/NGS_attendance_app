...
if(isset($_POST['needTo'])){
    if($_POST['needTo'] === 'get_msgs'){
        ...
        $get_msg =  $Announcements_Class->get_msgs_by_campaign_and_username($user_campaign,$user_name,$_POST['limit'],$_POST['offset']);
        if(!empty($get_msg)){
            $msgs_ids = [];
        ...
        /*
            // $get_msg =  $Announcements_Class->get_msgs_by_username($user_name,'agent',$_POST['limit'],$_POST['offset']);

            // $users_class = new Users_Class();
            // $user_data = $users_class->get_by_id($id);
            // $user_campaign =  $user_data[0]['campaign'];
            // $get_msg_campaign =  $Announcements_Class->get_msgs_by_campaign($user_campaign,'agent',$_POST['limit'],$_POST['offset']);
            ...
            // $Url_msg = '';
            // if(empty($get_msg)){
            //     $Url_msg = 'No Messages found';
            // }elseif(empty($get_msg_campaign)){
            //     $Url_msg = '';
            // }elseif(!empty($get_msg) && !empty($get_msg_campaign)){
            //     $By_username = $get_msg;
            //     $By_camp = $get_msg;
            // }elseif(!empty($get_msg_campaign)){
            //     $By_camp = $get_msg_campaign;
            // }elseif(!empty($get_msg)){
            //     $By_username = $get_msg;
            // }
        */
