...
if($rank === 'admin'){
    ...
    $sgin_in_link = ROOT.'sgin_in.php';
    header("location: $sgin_in_link");
}
?>
<!-- <!doctype html> -->
<html lang="en">
  <head>
    ...
    <style>
          ...
          *,
          ...
          .get_more_msgs_btn > span {
              cursor: pointer;
          }
          .get_more_msgs_btn > span:hover {
