...
if(isset($_POST['needTo'])){
    ...
    }elseif($_POST['needTo'] ==='delete_all_AutoGenerated'){
        // echo 'hi there';
        $Announcements_Class = new Announcements_Class();
        $Announcements_Class->delete_all_AutoGenerated();
        $results = ['state'=> 'good','msg'=>'all Auto Generated messages are deleted','url'=> '','respond'=>''];
        echo json_encode($results); 
    }elseif($_POST['needTo'] ==='get_msgs_by_userName'){
        $Announcements_Class = new Announcements_Class();
        $msgs = $Announcements_Class->get_msgs_by_username($_POST['user_name'],'admin',$_POST['limit'],$_POST['offset']);
        $results = ['state'=> 'good','msg'=>'','url'=> '','respond'=>$msgs];
        echo json_encode($results); 
    }elseif($_POST['needTo'] ==='get_msgs_by_camp'){
        $Announcements_Class = new Announcements_Class();
        $msgs = $Announcements_Class->get_msgs_by_campaign($_POST['camp_name'],'admin',$_POST['limit'],$_POST['offset']);
        $results = ['state'=> 'good','msg'=>'','url'=> '','respond'=>$msgs];
        echo json_encode($results); 
    }elseif($_POST['needTo'] ==='get_alerts_count'){
        $Announcements_Class = new Announcements_Class();
        $alert_count = $Announcements_Class->get_unread_msgs_count($user_name);
        print_r($alert_count);
    }elseif($_POST['needTo'] ==='get_alerts'){
        $Announcements_Class = new Announcements_Class();
        $alerts = $Announcements_Class->get_msgs_by_username($user_name,'admin',$_POST['limit'],$_POST['offset']);
        // data or 'no messages were found :('
        if(!empty($alerts) && $alerts != 'no messages were found :('){
            $msgs_ids = [];
            ...
            $results = ['state'=> 'good','msg'=>'','url'=> '','respond'=>$alerts];
        }else{
            $results = ['state'=> 'good','msg'=>'no alerts found','url'=> '','respond'=>''];
        }
        echo json_encode($results);
    }
