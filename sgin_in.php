...
<main class="form-signin w-100 m-auto">
  <form>
    ...
    <div class="remember_me_div mt-2 mb-2">
      <input type="checkbox" class="remember_me_input" id="remember_me_input" checked>
...
$(document).ready(function(){
    $("form").submit(function(event){
        ...
        var remember_me = document.getElementById('remember_me_input').checked
        if(remember_me){
          remember_me = 'true'
