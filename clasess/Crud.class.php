...
define("DATA_BASE", "user-registration"); // DATABASE NAME
...
/*=====================================================================
                             METHODE QUERY
=======================================================================*/
  public function query($query_p, ?int $fetchMode = null, ...$fetchModeArgs){
    // THIS WAS ADD ', ?int $fetchMode = null, ...$fetchModeArgs'
...
function debug($debug=NULL){
  echo "<pre><h2><strong>".__FILE__."</strong></h2><br>";
  print_r($debug);
  echo "</pre>";
}
